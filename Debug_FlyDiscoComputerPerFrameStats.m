...
FlyDiscoPlotPerFrameStats2(expdir,'settingsdir',settingsdir,'analysis_protocol',analysis_protocol,'debug',false,'makestimvideos',0,'plothist',2,'plotflies',true,'plotstimtrajs',0);
end
%%
