...
datafile = '/groups/branson/bransonlab/projects/olympiad/FlyBowlAnalysis/CollectedPrimaryPerFrameStats20131024.mat';
...
save('-v7.3',outdatafile,...
  ...
  'exp2lineidx','expdirs','line_names','linemeans','linemetadata','linensets',...
  'linestats','main_control_line_name','metadata','ncompartments','nexps',...
  'nlinesmissing','nlines','nsets','nstats','set2lineidx','set_names',...
  'setmeans','setmetadata','setnexps','setstats','statfns','vnc_regions','vncannotations');