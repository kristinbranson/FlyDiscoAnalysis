...
flytracker_calibration = loadAnonymous(flytracker_calibration_file_path) ;

% Call the core routine to compute the registration transform, and find the
% registration mark(s).
registration_params_cell = filterRegistrationParamsForFlyTrackerMethod(registration_params) ;
registration_data = determineRegistrationTransformForFlyTrackerMethodCore(registration_params_cell{:}, ...
                                                                          'bkgdImage',bkgdImage, ...
                                                                          'useNormXCorr',true, ...
