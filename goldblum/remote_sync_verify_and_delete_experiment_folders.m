function result = remote_sync_verify_and_delete_experiment_folders(source_user_name, ...
    ...
    fprintf("%d ABORTED experiment folders deleted\n", deleted_aborted_experiment_folder_count) ;
    fprintf("%d ABORTED experiment folders failed to delete\n", delete_error_count) ;
    ...
    did_synch_from_unaborted_experiment_folder_index = false(experiment_folder_count, 1) ;
    ...
    result = relative_path_from_unaborted_experiment_folder_index(did_synch_from_unaborted_experiment_folder_index) ;
end
