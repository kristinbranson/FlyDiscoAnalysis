function experiment_folder_path_list = find_experiment_folders(source_path)
    ...
    experiment_folder_path_list = find_experiment_folders_helper(source_path, spinner) ;
    spinner.stop() ;
