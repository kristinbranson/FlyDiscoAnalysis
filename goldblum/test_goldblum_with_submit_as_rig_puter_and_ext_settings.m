...
rig_host_name = 'submit.int.janelia.org' ;
rig_user_name = get_user_name() ;
rig_data_folder_path = 'fake-cygdrive-d' ;  % relative to users home dir
goldblum_destination_folder_path = fullfile(root_example_experiments_folder_path, 'test-goldblum-destination-folder') ;
settings_folder_path = fullfile(flydisco_folder_path, 'settings-internal') ;
