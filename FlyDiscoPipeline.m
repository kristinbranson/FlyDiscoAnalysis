function FlyDiscoPipeline(expdir, varargin)
    ...
    required_file_names_from_stage_name = FlyDiscoComputeRequiredFileNamesForAllStages(analysis_protocol_folder_path, dataloc_params, expdir) ;
    ...
    if do_run_core_pipeline ,
        ...
        FlyDiscoPipelineStage(...
            expdir, ...
            stage_name, ...
            do_run.computeperframefeatures, ...
            dataloc_params, ...
            requiredfiles, ...
            settingsdir, ...
            analysis_protocol, ...
