function fda_batch_track_single_video(output_folder_name, input_video_file_name, input_calibration_file_name, options, output_calibration_file_name)
    ...
    % This is a customized version for FlyDiscoAnalysis, just because they want to specify the name of the output calibration file.    
    ...
    output_calibration_file_path = fullfile(output_folder_path, output_calibration_file_name);
...
%     ensure_folder_does_not_exist(output_folder_path) ;
    ...
    % Declare victory
    fprintf('Success: fda_batch_track_single_video() is about to exit!\n') ;
end
