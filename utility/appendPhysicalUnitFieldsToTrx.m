function trx = appendPhysicalUnitFieldsToTrx(input_trx, usemediandt, meddt) 
% Add the x_mm, y_mm, a_mm, b_mm, theta_mm, dt, fps, and pxpermm fields to the
% input trx.
% This is a pure function.

% Deal with optional args
if ~exist('usemediandt', 'var') || isempty(usemediandt) ,
  usemediandt = false ;
end
if usemediandt && ~exist('meddt', 'var') ,
    error('If median interval is to be used, it must be supplied as an argument') ;
end  
