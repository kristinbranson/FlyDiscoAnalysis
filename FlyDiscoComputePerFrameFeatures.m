...
debug = false ;  % debug==true seems to cause infinite regress with computing angleonclosestfly ? -- ALT, 2024-07-24
...
if trx.perframe_params.isflytracker,
  ...
  if forcecompute || ~allexist,
    ...
    ft_tracks_input_file_path = determine_downstream_tracks_file_path(expdir, trx.dataloc_params, do_run) ;
