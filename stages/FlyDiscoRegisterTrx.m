...
% Parse arguments
%
[analysis_protocol,settingsdir,registrationparamsfilestr,datalocparamsfilestr,dotemporalreg,dotemporaltruncation,~,~,do_run] = ...
  myparse(varargin,...
...
trx_input_file_path = determine_downstream_trx_file_path(expdir, dataloc_params, do_run) ;
