...
rootdatadirs = {'/groups/branson/bransonlab/projects/olympiad/FlyBowlCtrax/20120228_non_olympiad_azanchir_housing_CS_20120225/results'};
outexpdirfilename = '/groups/branson/home/bransonk/behavioranalysis/code/Jdetect/Jdetect/experiments/datamanagement/expdirs_socialcon20121115.txt';
analysis_protocol = '20120706';
mintimestamp = '20120201T000000';
npar = 8;
...
fprintf('Ran:\n');
fprintf('qsub_FlyBowlFixPerFrameFeatures.pl ~/behavioranalysis/code/Jdetect/Jdetect/experiments/datamanagement/expdirs_socialcon20121115.txt\n');
...
for ii = 1:npar:numel(metadata),
  ...
  if mod(ii,100) < npar,
    save('CheckExperiments_socialcon_20121115.mat','issuccess','msgs','order','ii','metadata');
  end
...
fprintf('Ran:\n');
fprintf('./qsub_JAABADetect.pl ../experiments/datamanagement/expdirs_socialcon20121115.txt 20120228_non_olympiad_azanchir_housing_CS_20120225\n');
...
classifierparamsfiles = cellfun(@(x) fullfile(settingsdir,'20120228_non_olympiad_azanchir_housing_CS_20120225',x),classifierparamsfiles,'UniformOutput',false);
classifierfiles = {};
configfiles = {};
