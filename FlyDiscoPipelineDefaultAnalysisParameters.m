function result = FlyDiscoPipelineDefaultAnalysisParameters()
    ...
    result = ...
        {'automaticchecksincoming_params',{},...
         ...
         'requiredfiles_computeaptperframefeatures',{'perframe/nfeet_ground.mat'},...  % ALICE: Add required files to this list, so FlyDiscoPipeline() knows when to run the stage, and whether it worked
