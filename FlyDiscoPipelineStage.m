function FlyDiscoPipelineStage(expdir, ...
    ...
    if is_on_or_force(do_run_stage) ,
        ...
        if iscell(required_files_entity) ,
            required_files_for_stage_with_placeholders = required_files_entity ;
            required_files_for_stage = ...
                FlyDiscoReplaceRequiredFilePlaceholders(required_files_for_stage_with_placeholders, ...
                                                        ...
                                                        dataloc_params, ...
                                                        stage_additional_arguments) ;
        elseif isa(required_files_entity, 'function_handle') ,
            required_files_function = required_files_entity ;
            required_files_for_stage = ...
                feval(required_files_function, ...
                      stage_name, ...
                      expdir, ...
                      analysis_protocol_folder_path, ...
                      dataloc_params, ...
            ...
            error('required_files_entity must be a cell array of strings or a function handle') ;
        end
