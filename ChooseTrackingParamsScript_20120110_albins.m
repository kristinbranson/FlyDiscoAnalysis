...
rootdir_fixed = '';
rootoutputdir = '/groups/branson/bransonlab/projects/olympiad/FlyBowlCtrax/20120109_non_olympiad_azanchir/ctrax_test';

analysis_protocol = '20120110_non_olympiad_albins';
...
experiment_params.screen_type = 'non_olympiad_albins';
...
for i = 1:numel(experiments_all),
  if ~exist(fullfile(experiments_all(i).file_system_path,trxfilestr),'file'),
    baddata(i) = true;
  end
end
...
thresh_prctiles_area = [.25,100-.005];
thresh_prctiles_a = [.25,100-.01];
thresh_prctiles_b = [.25,100-.1];
thresh_prctiles_ecc = [.01,100-.25];
