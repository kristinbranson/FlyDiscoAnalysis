...
experiment_params.daterange = {'20110720T000000','20110723T000000'};
% required files
experiment_params.subreadfiles = {'ctrax_results.mat'};
% what lines
...
for i = 1:numel(experiments_all),
  experiments_all(i).exp_datetime = experiments_all(i).date;
  experiments_all(i).rig = str2double(experiments_all(i).rig);
end
