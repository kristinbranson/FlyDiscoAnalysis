...
result.intensity = input_protocol.(horzcat(primary_channel_prefix, 'intensity')) ;
result.pulseWidthSP = input_protocol.(horzcat(primary_channel_prefix, 'pulseWidth')) ;
result.pulsePeriodSP = input_protocol.(horzcat(primary_channel_prefix, 'pulsePeriod')) ;
result.pulseNum = input_protocol.(horzcat(primary_channel_prefix, 'pulseNum')) ;
result.offTime = input_protocol.(horzcat(primary_channel_prefix, 'offTime')) ;
result.iteration = input_protocol.(horzcat(primary_channel_prefix, 'iteration')) ;
