...
read_only_experiments_folder_path = fullfile(fly_disco_folder_path, 'example-experiments', 'single-adriane-experiment-2024-01-22-with-tracking-read-only') ;
working_experiments_folder_path = fullfile(fly_disco_folder_path, 'example-experiments', 'single-adriane-experiment-2024-01-22-with-tracking') ;
