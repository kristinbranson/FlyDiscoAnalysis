...
%           'docomputeperframestats',true,...
%           'doplotperframestats',true} ;
analysis_parameters = {'analysis_protocol', '20240402_flybubble_LED_LPC1_CsChr', ...
                       'docomputeperframestats', true, ...
                       'doplotperframestats', true } ;
...
read_only_experiments_folder_path = fullfile(fly_disco_folder_path, 'example-experiments', 'alice-2024-05-08-issue-read-only') ;
working_experiments_folder_path = fullfile(fly_disco_folder_path, 'example-experiments', 'alice-2024-05-08-issue') ;
