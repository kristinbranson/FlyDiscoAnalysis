...
settings_folder_path = ...
  '/groups/branson/bransonlab/taylora/flydisco/OtopalikFlyDiscoSettings-copied-from-prod-commit-2e33054/settings' ;  % at same commit as when prod run happened
do_use_bqueue = false ;
...
read_only_experiments_folder_path = fullfile(fly_disco_folder_path, 'example-experiments', 'chelo-issues-2025-07-02-read-only') ;
working_experiments_folder_path = fullfile(fly_disco_folder_path, 'example-experiments', 'chelo-issues-2025-07-02') ;
