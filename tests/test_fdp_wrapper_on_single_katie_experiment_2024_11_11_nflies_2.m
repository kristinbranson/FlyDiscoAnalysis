...
%settings_folder_path = '/groups/rubin/home/rubinlabuser/RubinFlyDiscoSettings/settings' ;
do_use_bqueue = true ;
...
read_only_experiments_folder_path = fullfile(fly_disco_folder_path, 'example-experiments', 'single-katie-experiment-2024-11-11-read-only') ;
working_experiments_folder_path = fullfile(fly_disco_folder_path, 'example-experiments', 'single-katie-experiment-2024-11-11-nflies-2') ;
