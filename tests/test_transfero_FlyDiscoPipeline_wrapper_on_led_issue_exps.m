...
read_only_experiments_folder_path = fullfile(fly_disco_folder_path, 'example-experiments', 'led-detection-issues-2023-09-01-read-only') ;
working_experiments_folder_path = fullfile(fly_disco_folder_path, 'example-experiments', 'led-detection-issues-2023-09-01') ;
