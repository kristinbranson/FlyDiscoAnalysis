...
analysis_protocol = '20120109_non_olympiad_azanchir';
...
thresh_prctiles_area = [.1,100-.75];
thresh_prctiles_a = [.5,100-1.5];
thresh_prctiles_b = [.1,100-.1];
thresh_prctiles_ecc = [.5,100-1];
