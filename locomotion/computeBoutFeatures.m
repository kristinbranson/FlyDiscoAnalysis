function [boutfeatures] = computeBoutFeatures(fly,trx,aptdata,tip_pos_body,limb,step_t0s,step_t1s,stance_t0s,stance_t1s,timestamps)
...
boutfeatures.frequency_steppers = 1./boutfeatures.duration_s;
